export const RU = {
    ...
    CHAT: {
        START_MESSAGE:
            'Привет! Я бот для психологического отбора кандидатов в сферу сервиса.\n\n' +
            'Напишите /assess чтобы начать оценку.',
        CANCEL_MESSAGE: '❌ Оценка отменена. Начать заново: /assess',
        ALREADY_COMPLETED:
            'Вы уже прошли оценку и получили результат.\n\nЧтобы пройти заново — /assess',
        NOT_STARTED: 'Напишите /assess чтобы начать оценку.',
    },
